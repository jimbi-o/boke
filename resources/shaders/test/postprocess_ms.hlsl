...
void main(out vertices VertexOut vertices[VERTEX_NUM], out indices uint3 faces[FACE_NUM]) {
  ...
  vertices[1].position = float4(-1.0f,  3.0f, 0.0f, 1.0f);
  vertices[1].uv = float2(0.0f, 2.0f);
  vertices[2].position = float4( 3.0f,  3.0f, 0.0f, 1.0f);
  vertices[2].uv = float2(2.0f, 0.0f);
  faces[0] = uint3(0, 1, 2);
}
